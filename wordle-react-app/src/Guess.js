...
export default function Guess({guesses, setGuesses, scoreLists, setScoreLists, hardMode, setHardMode}) {
    ...
    return (
        <>
            <QueryGuessScores operation="qguess" headers={ headers } headerLabels={headerLabels} guesses={guesses} setGuesses={setGuesses} scoreLists={scoreLists} setScoreLists={setScoreLists} bestGuessCount={bestGuessCount} hardMode={hardMode} >
